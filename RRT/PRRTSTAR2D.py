...
class RRT:
    ...
    def Att_potential_field(self, rnd):
        dis_Goal_rnd = math.sqrt((self.goal.x - rnd[0]) ** 2 + (self.goal.y - rnd[1]) ** 2)
    ...
    def RGD(self, rnd):
        ...
        for i in range(self.k):
            ...
            if dmin < dobs:
                ...
                prnd[0] = prnd[0] + dobs * Fatt[0]/math.sqrt(Fatt[0] ** 2 + Fatt[1] ** 2)
                prnd[1] = prnd[1] + dobs * Fatt[1] / math.sqrt(Fatt[0] ** 2 + Fatt[1] ** 2)
        return prnd
